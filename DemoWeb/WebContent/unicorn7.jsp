...
<body class="bg-cake-pattern">
  <main>
    <div class="product-details">
      <h1>Decorative Colorful Unicorn Cake</h1>
      <div class="product-images">
        <div class="main-image">
          <img src="product-image/Decorative Colorful Unicorn Cake.jpg" alt="Main Cake Image" id="mainImage">
        </div>
        <div class="zoomed-image" id="zoomedImage">
          <img src="product-image/Decorative Colorful Unicorn Cake.jpg" alt="Zoomed Cake Image">
        </div>
      </div>
         ...
         <div>
          <form action="CartServlet" method="post" target="_blank">
                  <input type="hidden" name="itemName" value="Photo Cake">
                    ...
                    <input type="hidden" name="imageUrl" value="product-image/Decorative Colorful Unicorn Cake.jpg">
