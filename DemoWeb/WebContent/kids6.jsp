    ...
    <div class="product-details">
      ...
      <div class="product-images">
        <div class="main-image">
          <img src="https://assets.winni.in/product/primary/2023/11/91813.jpeg?dpr=1&w=400" id="mainImage">
        </div>
        <div class="zoomed-image" id="zoomedImage">
          <img src="https://assets.winni.in/product/primary/2023/11/91813.jpeg?dpr=1&w=400" alt="Zoomed Cake Image">
        </div>
      </div>
         ...
         <div>
          <form action="CartServlet" method="post" target="_blank">
                  <input type="hidden" name="itemName" value="Photo Cake">
                    <input type="hidden" name="itemPrice" value="549.00">
                    <input type="hidden" name="imageUrl" value="https://assets.winni.in/product/primary/2023/11/91813.jpeg?dpr=1&w=400">
