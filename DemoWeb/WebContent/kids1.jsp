    ...
    <div class="product-details">
      ...
      <div class="product-images">
        <div class="main-image">
          <img src="https://assets.winni.in/product/primary/2021/9/53755.jpeg?dpr=1&w=400" alt="Main Cake Image" id="mainImage">
        </div>
        <div class="zoomed-image" id="zoomedImage">
          <img src="https://assets.winni.in/product/primary/2021/9/53755.jpeg?dpr=1&w=400" alt="Zoomed Cake Image">
        </div>
      </div>
      ...
      <div class="product-info">
        ...
        <div class="Rating">
                        ...
                        <div class="rating">
                            <span style="font-size:100%;color:rgb(255, 255, 255);">4.4 &starf;</span>
                        </div>
                    
          </div>
          <div class="price">₹<span id="price">549</span></div>
         ...
         <div>
          <form action="CartServlet" method="post" target="_blank">
                  <input type="hidden" name="itemName" value="Photo Cake">
                    ...
                    <input type="hidden" name="imageUrl" value="https://assets.winni.in/product/primary/2021/9/53755.jpeg?dpr=1&w=400">
