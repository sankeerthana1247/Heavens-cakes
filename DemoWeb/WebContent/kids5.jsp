  ...
  <style>
    ...
    * {
    ...
    body.bg-cake-pattern {
      background-image: url('product-image/background1.jpg');
...
<body class="bg-cake-pattern">
  <main>
    <div class="product-details">
      <h1>Flowery Personalized Vanila Cake</h1>
      <div class="product-images">
        <div class="main-image">
          <img src="https://assets.winni.in/product/primary/2014/8/41612.jpeg?dpr=1&w=400" id="mainImage">
        </div>
        <div class="zoomed-image" id="zoomedImage">
          <img src="https://assets.winni.in/product/primary/2014/8/41612.jpeg?dpr=1&w=400" alt="Zoomed Cake Image">
        </div>
      </div>
      ...
      <div class="product-info">
        ...
        <div class="Rating">
             ...
             <div class="rating">
                  <span style="font-size:100%;color:rgb(255, 255, 255);">4.6 &starf;</span>
              </div>
                    
          </div>
          <div class="price">₹<span id="price">759</span></div>
          <p>Weight: <a href="#" onclick="showServingInfo()">Serving Info</a></p>
        <div class="weight-container">
          <div class="weight clicked" data-price="549">0.5 kg</div>
          <div class="weight" data-price="1049">1 kg</div>
          <div class="weight" data-price="2049">2 kg</div>
          <div class="weight" data-price="3049">3 kg</div>
          <div class="weight" data-price="4049">5 kg</div>
        </div>
    ...
    <button onclick="checkPincode()" id="check">Check</button>
        ...
        <div class="cart-actions">
         ...
         <div>
          <form action="CartServlet" method="post" target="_blank">
                  <input type="hidden" name="itemName" value="Photo Cake">
                    <input type="hidden" name="itemPrice" value="40.00">
                    <input type="hidden" name="imageUrl" value="https://assets.winni.in/product/primary/2014/8/41612.jpeg?dpr=1&w=400">
         ...
         <form action="AddToWishlistServlet" method="post" target="_blank">
                  <input type="hidden" name="itemName" value="Photo Cake">
                    <input type="hidden" name="itemPrice" value="40.00">
                    <input type="hidden" name="imageUrl" value="hhttps://assets.winni.in/product/primary/2014/8/41612.jpeg?dpr=1&w=400">
                    <input type="hidden" name="description" value="A delicious car-shaped cake">
