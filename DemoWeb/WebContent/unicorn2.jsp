...
<body class="bg-cake-pattern">
  <main>
    <div class="product-details">
      <h1>Fairy Tale Unicorn Cake</h1>
      <div class="product-images">
        <div class="main-image">
          <img src="product-image/Fairy Tale Unicorn Cake.jpg" alt="Main Cake Image" id="mainImage">
        </div>
        <div class="zoomed-image" id="zoomedImage">
          <img src="product-image/Fairy Tale Unicorn Cake.jpg" alt="Zoomed Cake Image">
        </div>
      </div>
      ...
      <div class="product-info">
        ...
        <div class="Rating">
          ...
          <div class="price">₹<span id="price">899</span></div>
          <p>Weight: <a href="#" onclick="showServingInfo()">Serving Info</a></p>
        <div class="weight-container">
          <div class="weight clicked" data-price="899">0.5 kg</div>
         ...
         <div>
          <form action="CartServlet" method="post" target="_blank">
                  <input type="hidden" name="itemName" value="Photo Cake">
                    ...
                    <input type="hidden" name="imageUrl" value="product-image/Fairy Tale Unicorn Cake.jpg">
