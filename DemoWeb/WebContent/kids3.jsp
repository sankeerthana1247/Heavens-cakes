...
<body class="bg-cake-pattern">
  <main>
    <div class="product-details">
      <h1>White Forest Cake</h1>
      <div class="product-images">
        <div class="main-image">
          <img src="https://assets.winni.in/product/primary/2022/9/74671.jpeg?dpr=1&w=400" alt="Main Cake Image" id="mainImage">
        </div>
        <div class="zoomed-image" id="zoomedImage">
          <img src="https://assets.winni.in/product/primary/2022/9/74671.jpeg?dpr=1&w=400" alt="Zoomed Cake Image">
        </div>
      </div>
      ...
      <div class="product-info">
        ...
        <div class="Rating">
          ...
          <div class="price">₹<span id="price">749</span></div>
        ...
        <div class="weight-container">
          ...
          <div class="weight" data-price="2099">2 kg</div>
          <div class="weight" data-price="3549">3 kg</div>
         ...
         <div>
          <form action="CartServlet" method="post" target="_blank">
                  <input type="hidden" name="itemName" value="Photo Cake">
                    <input type="hidden" name="itemPrice" value="1049.00">
                    <input type="hidden" name="imageUrl" value="https://assets.winni.in/product/primary/2022/9/74671.jpeg?dpr=1&w=400">
