...
<body>   
  ...
  <div class="header">
    <h1>Photo Cakes <span>(8 items)</span></h1>
    <div class="filter-options">
        ...
        <div id="product-row">
            <div class="product-cell" data-price="499" data-rating="4.8">
                ...
                <a href="kids1.jsp">
                    <img src="https://assets.winni.in/product/primary/2021/9/53755.jpeg?dpr=1&w=400" class="product-image">
                </a>
               <div class="badge best-seller">Best Seller</div>
            <div class="product-title">Strawberry Addiction Photo Cake</div>
            ...
            <div class="product-cell" data-price="759" data-rating="4.5">
                <div class="product-container">
                <a href="kids2.jsp">
                <img src="https://assets.winni.in/product/primary/2024/4/95063.jpeg?dpr=1&w=400" 
                alt="Lipsmacking Black Forest Cake" class="product-image">
                </a>
                <div class="badge trending">Trending</div>
                <div class="product-title">Flowery Personalized Vanila Cake</div>
                <div class="product-price">
            ...
            <div class="product-cell" data-price="749" data-rating="4.8">
                <div class="product-container">
                <a href="kids3.jsp">
                <img src="https://assets.winni.in/product/primary/2022/9/74671.jpeg?dpr=1&w=400" 
                alt="Lipsmacking Black Forest Cake" class="product-image"></a>
                <div class="badge new-arrival">New Arrival</div>
                <div class="product-title">White Forest Cake</div>
                <div class="product-price">
        ...
        <div class="product-cell" data-price="1499" data-rating="5.0">
            <div class="product-container">
            <a href="kids4.jsp">
            <img src="https://assets.winni.in/product/primary/2021/9/53739.jpeg?dpr=1&w=400" 
            alt="Lipsmacking Black Forest Cake" class="product-image"></a>
            <div class="badge trending">Trending</div>
            <div class="product-title">Stawberry Addiction Photo Cake</div>
            <div class="product-price">
          ...
          <div class="product-cell" data-price="650" data-rating="4.1">
            <div class="product-container">
            <a href="kids5.jsp">
              <img src="https://assets.winni.in/product/primary/2014/8/41612.jpeg?dpr=1&w=400"
               alt="Lipsmacking Black Forest Cake" class="product-image"></a>
               <div class="badge new-arrival">New Arrival</div>
              <div class="product-title">Dark Desire Cake</div>
              <div class="product-price">
          ...
          <div class="product-cell" data-price="579" data-rating="4.9">
            <div class="product-container">
            <a href="kids6.jsp">
              <img src="https://assets.winni.in/product/primary/2023/11/91813.jpeg?dpr=1&w=400" 
              alt="Lipsmacking Black Forest Cake" class="product-image"></a>
             <div class="badge best-seller">Best Seller</div>
              <div class="product-title">Happy Birthday Photo Cake</div>
              <div class="product-price">
          ...
          <div class="product-cell" data-price="589" data-rating="4.4">
            <div class="product-container">
            <a href="kids7.jsp">
              <img src="https://assets.winni.in/product/primary/2014/8/34993.jpeg?dpr=1&w=400" 
              alt="Lipsmacking Black Forest Cake" class="product-image"></a>
              <div class="badge trending">Trending</div>
              <div class="product-title">Cutiepie Photot Cake</div>
              <div class="product-price">
