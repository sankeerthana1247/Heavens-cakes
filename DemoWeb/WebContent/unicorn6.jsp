    ...
    <div class="product-details">
      ...
      <div class="product-images">
        <div class="main-image">
          <img src="product-image/unicorncake.jpg" alt="Main Cake Image" id="mainImage">
        </div>
        <div class="zoomed-image" id="zoomedImage">
          <img src="product-image/unicorncake.jpg" alt="Zoomed Cake Image">
        </div>
      </div>
         ...
         <div>
          <form action="CartServlet" method="post" target="_blank">
                  <input type="hidden" name="itemName" value="Photo Cake">
                    ...
                    <input type="hidden" name="imageUrl" value="product-image/unicorncake.jpg">
