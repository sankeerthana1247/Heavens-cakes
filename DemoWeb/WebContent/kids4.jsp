...
<body class="bg-cake-pattern">
  <main>
    <div class="product-details">
      <h1>Strawberry Addiction Photo Cake</h1>
      <div class="product-images">
        <div class="main-image">
          <img src="https://assets.winni.in/product/primary/2021/9/53739.jpeg?dpr=1&w=400" id="mainImage">
        </div>
        <div class="zoomed-image" id="zoomedImage">
          <img src="https://assets.winni.in/product/primary/2021/9/53739.jpeg?dpr=1&w=400" alt="Zoomed Cake Image">
        </div>
      </div>
      ...
      <div class="product-info">
        ...
        <div class="Rating">
             ...
             <div class="rating">
                  <span style="font-size:100%;color:rgb(255, 255, 255);">5.0 &starf;</span>
              </div>
                    
          </div>
          <div class="price">₹<span id="price">1499</span></div>
         ...
         <div>
          <form action="CartServlet" method="post" target="_blank">
                  <input type="hidden" name="itemName" value="Photo Cake">
                    ...
                    <input type="hidden" name="imageUrl" value="https://assets.winni.in/product/primary/2021/9/53739.jpeg?dpr=1&w=400">
